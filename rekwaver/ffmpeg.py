...
def flac_to_wav(input_path, output_path):
    ...
    try:
        ...
        logger.error("FFmpeg not found. Please install it and make sure it's in your PATH.")
        return False
    except Exception as e:
        ...
        try:
            ...
            logger.debug('Failed to remove partial output %s after exception: %s', out_path, ex)
        return False
